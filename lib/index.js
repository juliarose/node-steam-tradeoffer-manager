...
Helpers.createOfferFromData = function(manager, data) {
	...
	return new TradeOfferManager.TradeOffer(manager, new SteamID('[U:1:' + data.accountid_other + ']'), null, data);
};
...
TradeOfferManager.prototype.createOffer = function(partner, token) {
	...
	var offer = new TradeOfferManager.TradeOffer(this, partner, token);
