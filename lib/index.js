...
Helpers.createOfferFromData = function(manager, data) {
	// we use the tradeoffer class attached to TradeOfferManager.
	return new manager.constructor.TradeOffer(manager, new SteamID('[U:1:' + data.accountid_other + ']'), null, data);
};
...
TradeOfferManager.prototype.createOffer = function(partner, token) {
	...
	var offer = new this.constructor.TradeOffer(this, partner, token);
...
TradeOfferManager.TradeOffer = TradeOffer;
TradeOfferManager.EconItem = EconItem;
